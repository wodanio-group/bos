<template>
  ...
  <div
    ...
    <div
      class="fixed flex flex-col top-[50%] left-[50%] max-h-[85vh] w-[90vw] max-w-[500px] translate-x-[-50%] translate-y-[-50%] p-4 bg-white border border-secondary-200 rounded-xl shadow-xl shadow-secondary-100 z-[999]">
      <button
        type="button"
