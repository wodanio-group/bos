...
- **Task Management** with assignable tasks, due dates, priorities, and status tracking
- **Lead & Opportunity Management** with pipeline stages, probability tracking, and value estimation
- **Quote Management** with line items, tax calculation, PDF export via Gotenberg, and automatic quote numbering
